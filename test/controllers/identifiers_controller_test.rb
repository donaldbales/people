...
class IdentifiersControllerTest < ActionController::TestCase
  ...
  test "should create identifier" do
    assert_difference('Identifier.count') do
      post :create, identifier: { active_datetime: @identifier.active_datetime, identifier_type_id: @identifier.identifier_type_id, inactive_datetime: @identifier.inactive_datetime, value: @identifier.value }
    end
  ...
  test "should update identifier" do
    patch :update, id: @identifier, identifier: { active_datetime: @identifier.active_datetime, identifier_type_id: @identifier.identifier_type_id, inactive_datetime: @identifier.inactive_datetime, value: @identifier.value }
    assert_redirected_to identifier_path(assigns(:identifier))
  end
