...
class IdentifierTypesControllerTest < ActionController::TestCase
  ...
  test "should create identifier_type" do
    assert_difference('IdentifierType.count') do
      post :create, identifier_type: { active_datetime: @identifier_type.active_datetime, code: @identifier_type.code, description: @identifier_type.description, inactive_datetime: @identifier_type.inactive_datetime }
    end
  ...
  test "should update identifier_type" do
    patch :update, id: @identifier_type, identifier_type: { active_datetime: @identifier_type.active_datetime, code: @identifier_type.code, description: @identifier_type.description, inactive_datetime: @identifier_type.inactive_datetime }
    assert_redirected_to identifier_type_path(assigns(:identifier_type))
  end
