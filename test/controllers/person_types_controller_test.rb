...
class PersonTypesControllerTest < ActionController::TestCase
  ...
  test "should create person_type" do
    assert_difference('PersonType.count') do
      post :create, person_type: { active_datetime: @person_type.active_datetime, code: @person_type.code, description: @person_type.description, inactive_datetime: @person_type.inactive_datetime }
    end
  ...
  test "should update person_type" do
    patch :update, id: @person_type, person_type: { active_datetime: @person_type.active_datetime, code: @person_type.code, description: @person_type.description, inactive_datetime: @person_type.inactive_datetime }
    assert_redirected_to person_type_path(assigns(:person_type))
  end
